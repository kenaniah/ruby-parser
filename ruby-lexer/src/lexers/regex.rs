...
pub fn regular_expression_body(i: Input) -> ParseResult {
    stub_p(i)
}
...
pub fn regular_expression_character(i: Input) -> ParseResult {
    stub_p(i)
}

/// `\` *regular_expression_unescaped_character*
pub fn regular_expression_unescaped_sequence(i: Input) -> ParseResult {
    stub_p(i)
}

/// *source_character* **but not** ( 0x0d | 0x0a ) | 0x0d **not** 0x0a
pub fn regular_expression_unescaped_character(i: Input) -> ParseResult {
    stub_p(i)
}

/// `\` `/`
pub fn regular_expression_escape_sequence(i: Input) -> ParseResult {
    stub_p(i)
}

/// `i` | `m`
pub fn regular_expression_option(i: Input) -> ParseResult {
    stub_p(i)
}
